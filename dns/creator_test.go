...
func TestPrepareData(t *testing.T) {
  ...
  "resource.hello-server.perf.portal.portal-hello": {
	...
	expect := []string{
		...
		"+registry.lain:192.168.77.201:300::",
		"+deploy.lain:192.168.77.201:300::",
		"+perf.lain:192.168.77.201:300::",
		"+console.lain:192.168.77.201:300::",
		"+tinydns.lain:192.168.77.201:300::",
